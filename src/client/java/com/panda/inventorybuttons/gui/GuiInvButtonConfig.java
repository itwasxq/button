...
public class GuiInvButtonConfig extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawString(this.font, titleText, -tW / 2, -this.font.lineHeight / 2, 0xFFFFFFFF, true);
        ...
        if (button == 0) {
            ...
            if (mouseY >= boxY && mouseY < boxY + 16) {
                if (mouseX >= boxX && mouseX < boxX + tabW) {
                    ...
                    if(this.minecraft != null) this.minecraft.getSoundManager().play(SimpleSoundInstance.forUI(SoundEvents.UI_BUTTON_CLICK.value(), 1.0F));
                    return true;
                }
